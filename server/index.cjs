...
app.use('/api/jobs', require('./routes/jobs.cjs'));
app.use('/api/bids', require('./routes/bids.cjs'));
app.use('/api/contracts', require('./routes/contracts.cjs'));
...
const socketHandler = require('./sockets/socketHandler.cjs');
socketHandler(io);
